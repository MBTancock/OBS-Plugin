 ...
 * generated in the com.avid.central.obsplugin.inewslibrary.inewssystem.types package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.avid.central.obsplugin.inewslibrary.inewssystem.types
     * 
     */
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link UnlockStoryType }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://avid.com/inewsstory/types", name = "UnlockStory")
    public JAXBElement<UnlockStoryType> createUnlockStory(UnlockStoryType value) {
        return new JAXBElement<UnlockStoryType>(_UnlockStory_QNAME, UnlockStoryType.class, null, value);
    }
