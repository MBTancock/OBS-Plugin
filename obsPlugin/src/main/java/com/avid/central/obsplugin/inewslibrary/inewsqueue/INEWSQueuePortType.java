...
public interface INEWSQueuePortType {
     ...
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.SetCurrentQueueResponseType
     ...
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.GetStoriesResponseType
     * @throws ConnectionFault
     ...
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.HasNextResponseType
     * @throws ConnectionFault
     * @throws HasNextFault
     */
     ...
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.HasPreviousResponseType
     ...
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.CreateStoryResponseType
     ...
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.GetStoryResponseType
     * @throws ConnectionFault
     ...
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.GetAttributesResponseType
     * @throws ConnectionFault
    ...
    /**
     * 
     *       This request gets a list of queue records from a queue, starting at the top of the queue.  Each subsequent
     *       request will get the next group of records from the queue if the call is not reset.  Each group may include
     *       the last record from the previous request.  Use the reset option to start listing records from the top of the
     *       queue again.
     *       
     * 
     * @param body
     * @return
     *     returns com.avid.central.obsplugin.inewslibrary.inewsqueue.types.GetQueueRecordsResponseType
     * @throws ConnectionFault
     * @throws GetQueueRecordsFault
     */
    @WebMethod(operationName = "GetQueueRecords")
    @WebResult(name = "GetQueueRecordsResponse", targetNamespace = "http://avid.com/inewsqueue/types", partName = "body")
    public GetQueueRecordsResponseType getQueueRecords(
        @WebParam(name = "GetQueueRecords", targetNamespace = "http://avid.com/inewsqueue/types", partName = "body")
        GetQueueRecordsType body)
        throws ConnectionFault, GetQueueRecordsFault
    ;
