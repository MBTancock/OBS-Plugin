 ...
 * 
 */
@WebServiceClient(name = "Assets", targetNamespace = "http://avid.com/interplay/ws/assets", wsdlLocation = "http://lookup.wysdom.local/services/Assets?wsdl")
public class Assets
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://lookup.wysdom.local/services/Assets?wsdl");
