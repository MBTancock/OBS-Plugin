 ...
 * 
 */
@WebServiceClient(name = "Infrastructure", targetNamespace = "http://avid.com/interplay/ws/infrastructure", wsdlLocation = "http://lookup/services/Infrastructure?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://lookup/services/Infrastructure?wsdl");
