 ...
 *         &lt;element name="Results" type="{http://avid.com/interplay/ws/assets/types}ReservationListType" minOccurs="0"/&gt;
...
public class GetReservationsResponseType {
    ...
    protected ReservationListType results;
     ...
     * @return
     *     possible object is
     *     {@link ReservationListType }
     *     
     */
    public ReservationListType getResults() {
        return results;
    }
     ...
     *     
     */
    public void setResults(ReservationListType value) {
        this.results = value;
    }
