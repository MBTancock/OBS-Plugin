...
/**
 * 
 *         An error that occurred during the processing of a request. The Code is a short string
 *         representing a type of error. The Message contains a short description of the error. The
 *         Details contains additional information more useful for debugging. If the error pertained
 *         to a particular node, an InterplayURI will be specified.
 *       
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="InterplayURI" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
